...
export const services: ServiceData[] = [
  {
    ...
    metaDescription: "Professional site preparation services in Cincinnati. Land clearing, grubbing, rough grading, and construction site prep. Get your property build-ready with Cardinal Dirtworks",
    ...
    fullDescription: [
      ...
      "At Cardinal Dirtworks, we handle the complete site preparation process from start to finish. That means clearing vegetation, removing stumps and debris, establishing proper grades, and ensuring your site is fully ready for your contractors to break ground without delays or surprises.",
  ...
  },
  {
    ...
    metaDescription: "Expert excavation services in Greater Cincinnati. Foundation excavation, basement digging, pond construction, pool excavation. Precision earthwork by Cardinal Dirtworks",
    image: "/images/excavation.png",
    heroVideo: "/videos/excavator-main.mp4",
    fullDescription: [
      "Excavation is at the heart of what we do. Whether you need a basement dug for a new home, a foundation prepared for an addition, a pond excavated on your acreage, or a pool installed in your backyard, Cardinal Dirtworks delivers precise, efficient excavation throughout Greater Cincinnati and Northern Kentucky.",
  ...
  },
  {
    ...
    metaDescription: "Professional grading and earthwork services in Cincinnati. Finish grading, land leveling, drainage solutions. Transform your terrain with Cardinal Dirtworks",
    image: "/images/grading.png",
    heroVideo: "/videos/drone-land-clearing.mp4",
    fullDescription: [
      "Proper grading is one of the most important — and most overlooked — elements of any property improvement or construction project. Whether you need finish grading for a new lawn, slope correction to prevent water damage, precise construction grading, or a major earthwork project, Cardinal Dirtworks has the expertise and equipment to deliver results throughout Greater Cincinnati.",
  ...
  },
  {
    ...
    metaDescription: "Land clearing and forestry mulching services in Cincinnati. Brush removal, vegetation clearing, lot clearing. Reclaim your property with Cardinal Dirtworks",
    ...
    fullDescription: [
      ...
      "Cardinal Dirtworks specializes in forestry mulching, one of the most efficient and environmentally responsible land clearing methods available. Our purpose-built forestry mulchers grind vegetation — brush, saplings, and trees — into fine mulch directly on site. This eliminates the need for burning or hauling massive amounts of debris, and the resulting mulch layer returns nutrients to the soil while providing immediate erosion control.",
  ...
  },
  {
    ...
    metaDescription: "Professional demolition services in Greater Cincinnati. Building teardowns, concrete removal, debris hauling. Safe, efficient demolition by Cardinal Dirtworks",
    image: "/images/demolition.png",
    heroVideo: "/videos/bulldozer-tracking.mp4",
    fullDescription: [
      "Sometimes you need to tear down before you can build up. Cardinal Dirtworks provides professional demolition services for structures, concrete, and other obstacles standing in the way of your next project — serving homeowners and contractors throughout Greater Cincinnati and Northern Kentucky.",
  ...
  },
  {
    ...
    metaDescription: "Utility trenching services in Greater Cincinnati. Water, sewer, electric, gas, and communications lines. Professional trenching by Cardinal Dirtworks",
    image: "/images/trenching.png",
    heroVideo: "/videos/excavator-burying-trench.mp4",
    fullDescription: [
      "Underground utilities are the essential infrastructure that makes modern properties functional — water, sewer, electric, gas, communications, and fiber optic lines all need to get from point A to point B through properly excavated trenches. When you need trenching done right, Cardinal Dirtworks delivers clean, precisely-graded utility trenches throughout Greater Cincinnati and Northern Kentucky.",
  ...
  },
  {
    ...
    metaDescription: "Driveway and road construction in Cincinnati. Gravel driveways, access roads, turnarounds. Professional driveway building by Cardinal Dirtworks",
    image: "/images/driveway.png",
    heroVideo: "/videos/concrete-crew.mp4",
    fullDescription: [
      "A well-built driveway or access road is one of those things you don't think about until it fails. A poorly constructed driveway washes out in heavy rain, develops ruts under vehicle weight, or turns into a muddy mess every spring. Cardinal Dirtworks builds gravel driveways and access roads that hold up — throughout Greater Cincinnati's wet springs, hot summers, and freezing winters.",
...
export const commercialServices: ServiceData[] = [
  {
    ...
    metaDescription: "Commercial site preparation in Greater Cincinnati. Land clearing, grubbing, mass grading for development projects. Cardinal Dirtworks delivers build-ready sites on schedule.",
    image: "/images/site-prep.png",
    heroVideo: "/videos/drone-excavator-topdown.mp4",
    fullDescription: [
      "Commercial construction projects live or die by what happens before the first foundation wall goes in. Site preparation sets the stage for every trade that follows — grading mistakes, inadequate clearing, and improper erosion control at this phase create cascading problems that cost far more to fix mid-project than to prevent upfront. Cardinal Dirtworks specializes in commercial site preparation throughout Greater Cincinnati, Northern Kentucky, and Southeast Indiana.",
    ...
    testimonial: {
      quote: "Cardinal Dirtworks kept our site prep on schedule when we had to compress the timeline by two weeks. They read the civil plans, coordinated with our engineer directly, and delivered a build-ready site without us babysitting. That's what you need on a commercial job.",
      name: "Brian M.",
      location: "Mason, OH",
  ...
  },
  {
    ...
    metaDescription: "Commercial excavation services in Greater Cincinnati. Foundation excavation, basement digging, retention ponds, commercial earthwork. Cardinal Dirtworks delivers precision at scale.",
    image: "/images/excavation.png",
    heroVideo: "/videos/excavator-main.mp4",
    fullDescription: [
      "Commercial excavation demands precision, scale, and the kind of project coordination that keeps complex construction timelines on track. Cardinal Dirtworks delivers commercial excavation services across Greater Cincinnati, handling projects from multi-unit residential foundations to large commercial building footprints, retention basins, and infrastructure excavation.",
    ...
    testimonial: {
      quote: "We hit rock about four feet down on our Florence site — not a surprise in Boone County but still a problem. Cardinal Dirtworks had a hammer on-site the next morning and pushed through without killing our schedule. Solid communication the whole way through.",
      name: "Derek W.",
  ...
  },
  {
    ...
    testimonial: {
      quote: "Our site had about 40,000 yards of cut and fill to balance. Cardinal Dirtworks reviewed our civil plans, gave us a realistic schedule, and executed it without a bunch of surprises. The building pad passed compaction testing first try. That's what you want.",
      name: "Jason T.",
  ...
  },
  {
    ...
    metaDescription: "Commercial land clearing in Greater Cincinnati. Large-scale vegetation removal, forestry mulching, commercial lot clearing. Cardinal Dirtworks clears the way for your development.",
    image: "/images/land-clearing.png",
    heroVideo: "/videos/drone-land-clearing.mp4",
    fullDescription: [
      "Commercial land clearing is the critical first step that transforms raw wooded or overgrown acreage into a productive development site. Whether you're a developer breaking ground on a new residential subdivision, a contractor clearing a commercial building lot, or a business acquiring land for industrial use, Cardinal Dirtworks handles large-scale land clearing throughout Greater Cincinnati, Northern Kentucky, and Southeast Indiana.",
    ...
    testimonial: {
      quote: "We had 22 acres of heavy woods in Clermont County that needed to be cleared before the subdivider could start grading. Cardinal Dirtworks cleared it in just under two weeks — clean, within our clearing limits, and ready for the earthwork crew. No drama, just results.",
      name: "Curtis P.",
      location: "Batavia, OH",
  ...
  },
  {
    ...
    metaDescription: "Commercial demolition services in Greater Cincinnati. Building teardowns, concrete removal, site clearing for redevelopment. Cardinal Dirtworks handles commercial demo safely and efficiently.",
    image: "/images/demolition.png",
    heroVideo: "/videos/bulldozer-tracking.mp4",
    fullDescription: [
      "Commercial demolition is a different discipline than residential work — larger structures, more complex utility disconnections, potential for regulated materials, and stricter permitting requirements all demand a contractor with real commercial demo experience. Cardinal Dirtworks handles commercial demolition projects throughout Greater Cincinnati, delivering safe, efficient teardowns that prepare sites for redevelopment.",
    ...
    testimonial: {
      quote: "We bought an older strip center in Anderson Township and needed the existing building down before we could start on the new build. Cardinal Dirtworks handled the permits, coordinated the utility disconnections, and had the site cleared and graded in four days. Exactly what we needed.",
      name: "Mark D.",
  ...
  },
  {
    ...
    metaDescription: "Commercial drainage and stormwater management in Greater Cincinnati. Retention ponds, detention basins, French drains, storm sewer. Cardinal Dirtworks executes civil drainage plans.",
    image: "/images/drainage.png",
    heroVideo: "/videos/drainage-aerial.mp4",
    fullDescription: [
      "Stormwater management is one of the most regulated and technically complex aspects of commercial development in Greater Cincinnati. The region's municipalities have implemented increasingly stringent stormwater requirements, and executing the drainage infrastructure correctly — on time and to specification — is critical for project approval and long-term performance. Cardinal Dirtworks executes commercial drainage and stormwater infrastructure throughout the region.",
    ...
    testimonial: {
      quote: "The basin on our West Chester project had tight elevation specs — the outlet structure wouldn't work if we were off more than a tenth. Cardinal Dirtworks hit it with GPS grade control and the system passed the engineer's inspection first time. That's the standard we expect.",
      name: "Phil R.",
      location: "West Chester, OH",
  ...
  },
  {
    ...
    testimonial: {
      quote: "Cardinal Dirtworks ran about 800 feet of water main and sanitary sewer trench for our Lebanon development. They coordinated with both utility districts, had the right bedding materials on-site, and backfilled to the compaction specs without us having to chase them. Smooth operation.",
      name: "Greg H.",
      location: "Lebanon, OH",
  ...
  },
  {
    ...
    metaDescription: "Commercial driveway and parking lot construction in Greater Cincinnati. Gravel drives, parking subgrade, access roads for business properties. Cardinal Dirtworks builds commercial access infrastructure.",
    image: "/images/driveway.png",
    heroVideo: "/videos/concrete-crew.mp4",
    fullDescription: [
      "Commercial driveways, access roads, and parking lots serve a different load demand than residential — delivery trucks, heavy equipment, and high vehicle frequency require proper subgrade preparation, adequate base depth, and drainage that handles commercial-scale impervious surface runoff. Cardinal Dirtworks builds commercial access infrastructure throughout Greater Cincinnati, from gravel construction access roads to permanent commercial drive entrances and parking area subgrades.",
    ...
    testimonial: {
      quote: "We needed a construction access road that could handle loaded concrete trucks on a tight Milford site. Cardinal Dirtworks built it right — geotextile, proper base depth, good drainage — and it held up through the entire build without turning into a mud pit. Worth every dollar.",
      name: "Tom A.",
      location: "Milford, OH",
...
export const residentialServices: ServiceData[] = [
  {
    ...
    metaDescription: "Residential excavation services in Greater Cincinnati. Foundation excavation, basement digging, pool excavation, pond construction. Cardinal Dirtworks digs it right the first time.",
    image: "/images/excavation.png",
    heroVideo: "/videos/excavator-digs-trench.mp4",
    fullDescription: [
      "Your home is your biggest investment, and excavation is where that investment gets its foundation — literally. Whether you're building a new home, adding a basement to an existing structure, installing an in-ground pool, or creating a backyard pond, Cardinal Dirtworks delivers precision residential excavation throughout Greater Cincinnati and Northern Kentucky.",
  ...
  },
  {
    ...
    metaDescription: "Residential land clearing in Greater Cincinnati. Lot clearing, brush removal, forestry mulching for homeowners. Reclaim your property with Cardinal Dirtworks",
    image: "/images/land-clearing.png",
    heroVideo: "/videos/drone-land-clearing.mp4",
    fullDescription: [
      "You bought the property for a reason — but maybe it's hard to enjoy it with overgrown brush, invasive honeysuckle, and trees you never wanted taking over. Or maybe you're building on a wooded lot and need it cleared before construction can begin. Either way, Cardinal Dirtworks makes residential land clearing straightforward, efficient, and surprisingly affordable throughout Greater Cincinnati.",
    ...
    testimonial: {
      quote: "Our back two acres had been overtaken by honeysuckle for years — you literally couldn't walk through it. Cardinal Dirtworks came out, looked at it, and had a realistic plan. They cleared it in two days and left the good trees standing. We can actually enjoy our property now.",
      name: "Laura M.",
  ...
  },
  {
    ...
    metaDescription: "Residential demolition services in Greater Cincinnati. Shed and garage teardowns, concrete removal, driveway demolition. Cardinal Dirtworks clears the way for your next project.",
    image: "/images/demolition.png",
    heroVideo: "/videos/bulldozer-tracking.mp4",
    fullDescription: [
      "That old shed that's falling down. The detached garage that's too far gone to repair. The cracked concrete driveway that's been an eyesore for years. The above-ground pool that nobody's used in a decade. These are the residential demolition projects Cardinal Dirtworks handles every week throughout Greater Cincinnati — quick, clean, and out of your way so you can move forward with whatever you've got planned.",
    ...
    testimonial: {
      quote: "Had a huge old bank barn on a property I bought in Batavia. It was falling in on itself and needed to go before I could do anything with the land. Cardinal Dirtworks knocked it down, sorted the metal for recycling, and had the site cleaned up in two days. Very professional.",
      name: "Dave R.",
      location: "Batavia, OH",
  ...
  },
  {
    ...
    metaDescription: "Residential drainage solutions in Greater Cincinnati. French drains, yard drainage, downspout routing, water management. Cardinal Dirtworks keeps water where it belongs.",
    image: "/images/drainage.png",
    heroVideo: "/videos/drainage-aerial.mp4",
    fullDescription: [
      "Water in the wrong place is one of the most damaging — and most stressful — problems a homeowner can face. Water seeping into your basement, pooling in your backyard after every rain, eroding your landscaping, or coming too close to your foundation aren't just inconveniences. Left unaddressed, they cause real structural damage, mold, and degraded home value. Cardinal Dirtworks provides residential drainage solutions that fix the actual problem throughout Greater Cincinnati.",
    ...
    testimonial: {
      quote: "After every rain we had water coming into the basement. We'd tried other fixes that didn't work. Cardinal Dirtworks actually walked the yard, figured out where the water was coming from, and installed a French drain with a proper outlet downhill. First heavy rain — dry basement. Should have called them two years ago.",
      name: "Nancy B.",
      location: "Anderson Township, OH",
  ...
  },
  {
    ...
    metaDescription: "Residential underground utility installation in Greater Cincinnati. Water lines, sewer connections, electric burial, communications. Cardinal Dirtworks handles residential utility excavation.",
    image: "/images/trenching.png",
    heroVideo: "/videos/excavator-burying-trench.mp4",
    fullDescription: [
      "Underground utilities are the invisible infrastructure your home depends on — water, sewer, electricity, and communications running through the ground to your house every day. When those systems need to be installed, repaired, or extended, the excavation work needs to be done carefully, to the right depth, and with proper backfill to protect both the utility and your yard. Cardinal Dirtworks handles residential underground utility excavation throughout Greater Cincinnati.",
  ...
  },
  {
    ...
    metaDescription: "Residential driveway construction in Greater Cincinnati. Gravel driveways, sidewalks, access improvements for homes. Cardinal Dirtworks builds driveways that hold up.",
    image: "/images/driveway.png",
    heroVideo: "/videos/concrete-crew.mp4",
    fullDescription: [
      "Your driveway gets used multiple times every day, year after year, through Ohio's wet springs, summer heat, and freeze-thaw winters. A properly built gravel driveway should handle all of that without washing out, rutting, or turning into a muddy obstacle. Cardinal Dirtworks builds residential gravel driveways throughout Greater Cincinnati — new construction, replacements, and expansions — focused on the base and drainage that make the difference between a driveway that lasts and one that doesn't.",
    ...
    testimonial: {
      quote: "We had a 300-foot driveway that turned into a mud pit every spring. Three different guys had thrown gravel on it and it never held. Cardinal Dirtworks actually excavated it, put down fabric, proper base, and then the finish stone. That was two years ago — it's still looking great after two winters. Wish we'd done it right the first time.",
      name: "Kevin L.",
  ...
  },
  {
    ...
    metaDescription: "Professional yard grading and leveling in Cincinnati. Slope correction, building pad prep, drainage grading for homeowners. Cardinal Dirtworks gets your ground right.",
  ...
  },
  {
    ...
    metaDescription: "Retaining wall construction in Cincinnati. Boulder walls, block walls, timber walls for hillside properties. Professional slope stabilization by Cardinal Dirtworks",
  ...
  },
  {
    ...
    metaDescription: "Inground pool removal in Cincinnati. Pool demolition, backfill, and regrading for homeowners. Reclaim your backyard with Cardinal Dirtworks",
  ...
  },
  {
    ...
    metaDescription: "Pond construction and water feature excavation in Cincinnati. Farm ponds, decorative ponds, stock tanks for homeowners. Professional pond digging by Cardinal Dirtworks",
  ...
  },
  {
    ...
    metaDescription: "Concrete removal and demolition in Cincinnati. Old patios, sidewalks, driveways, pool decks, and foundation removal. Clean demolition by Cardinal Dirtworks",
  ...
  },
  {
    ...
    metaDescription: "Septic system installation and replacement in Cincinnati. Tank excavation, drain field trenching, septic repairs. Professional septic work by Cardinal Dirtworks",
  ...
  },
  {
    ...
    metaDescription: "Foundation excavation in Cincinnati. Waterproofing dig-outs, footer drain installation, crawl space access, foundation repair excavation. Cardinal Dirtworks",
  ...
  },
  {
    ...
    metaDescription: "Residential lot preparation in Cincinnati. Building pad prep for garages, barns, sheds, ADUs, and outbuildings. Professional clearing and grading by Cardinal Dirtworks",
  ...
  },
  {
    ...
    metaDescription: "Residential snow removal in Cincinnati. Driveway plowing, snow pushing, and property clearing for homeowners. Professional snow removal by Cardinal Dirtworks",
  ...
  },
  {
    ...
    metaDescription: "Stump removal and grinding in Cincinnati. Tree stump extraction, root ball removal, stump grinding for homeowners. Professional stump removal by Cardinal Dirtworks",
  ...
  },
  {
    ...
    metaDescription: "Erosion control in Cincinnati. Hillside stabilization, riprap installation, drainage solutions, silt fencing for homeowners. Stop erosion with Cardinal Dirtworks",
