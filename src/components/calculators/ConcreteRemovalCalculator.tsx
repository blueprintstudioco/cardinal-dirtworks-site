          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              <button
                ...
                className={`p-3 rounded-lg border-2 text-left transition ${thickness === opt.val ? 'border-[#D62828] bg-[#D62828]/10' : 'border-gray-200 hover:border-gray-300'}`}
              >
        ...
        <div className="mb-6">
          <label className="flex items-center gap-3 cursor-pointer">
            <input
              ...
              className="w-5 h-5 accent-[#D62828] rounded"
            />
            <div>
