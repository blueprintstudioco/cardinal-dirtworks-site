    ...
    <div className="max-w-2xl mx-auto">
      <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
        <div className="flex items-center gap-3 mb-6">
          <div className="bg-[#D62828]/20 p-2 rounded-lg">
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className={`p-3 rounded-lg border-2 text-left transition ${removalType === 'partial' ? 'border-[#D62828] bg-[#D62828]/10' : 'border-gray-200 hover:border-gray-300'}`}
            >
            ...
            <button
              ...
              className={`p-3 rounded-lg border-2 text-left transition ${removalType === 'full' ? 'border-[#D62828] bg-[#D62828]/10' : 'border-gray-200 hover:border-gray-300'}`}
            >
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              <button
                ...
                className={`p-3 rounded-lg border-2 text-center transition ${poolType === opt.val ? 'border-[#D62828] bg-[#D62828]/10' : 'border-gray-200 hover:border-gray-300'}`}
              >
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div>
            ...
            <input
              ...
              className="w-full border-2 border-gray-200 rounded-lg px-4 py-2.5 focus:border-[#D62828] focus:outline-none transition"
            />
          </div>
          <div>
