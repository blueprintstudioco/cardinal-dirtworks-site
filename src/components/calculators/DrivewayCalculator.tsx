        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className={`p-3 rounded-lg border-2 text-left transition ${isNew ? 'border-[#D62828] bg-[#D62828]/10' : 'border-gray-200 hover:border-gray-300'}`}
            >
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              <button
                ...
                className={`p-3 rounded-lg border-2 text-left transition ${material === opt.val ? 'border-[#D62828] bg-[#D62828]/10' : 'border-gray-200 hover:border-gray-300'}`}
              >
