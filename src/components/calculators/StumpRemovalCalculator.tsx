    ...
    <div className="max-w-2xl mx-auto">
      <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className={`p-3 rounded-lg border-2 text-left transition ${method === 'grinding' ? 'border-[#D62828] bg-[#D62828]/10' : 'border-gray-200 hover:border-gray-300'}`}
            >
            ...
            <button
              ...
              className={`p-3 rounded-lg border-2 text-left transition ${method === 'extraction' ? 'border-[#D62828] bg-[#D62828]/10' : 'border-gray-200 hover:border-gray-300'}`}
            >
        ...
        <div className="mb-6">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="flex-1 accent-[#D62828]"
                    />
          ...
          <button
            onClick={addStump}
            className="mt-3 text-sm text-[#D62828] hover:text-[#a8bc20] font-semibold flex items-center gap-1"
          >
            + Add another stump
          </button>
          {stumps.length >= 3 && (
